...
<div style={{textAlign: "center"}}>
<img  src={CreateButton} width="60%" alt="The dashboard is shown and the create button is circled"/>
</div>
In the dashboard, press the orange “Create” button.
<div style={{textAlign: "center"}}>
<img  src={SearchCollections} width="70%" alt="The dashboard is shown and the create button is circled"/>
</div>
...
<div style={{textAlign: "center"}}>
<img  src={SelectedCollection} width="70%" alt="The dashboard is shown and the create button is circled"/>
</div>
...
<div style={{textAlign: "center"}}>
<img  src={IntroHierarchy} width="70%" alt="The dashboard is shown and the create button is circled"/>
</div>
:::info
...
<div style={{textAlign: "center"}}>
<img  src={CreateElement} width="70%" alt="The dashboard is shown and the create button is circled"/>
</div>
:::info
...
<div style={{textAlign: "center"}}>
<img  src={MathHelpSite} width="70%" alt="The dashboard is shown and the create button is circled"/>
</div>
...
<div style={{textAlign: "center"}}>
<img  src={AlgElement} width="60%" alt="The dashboard is shown and the create button is circled"/>
</div>
Press “Create Element” to add this element to the collection.
<div style={{textAlign: "center"}}>
<img  src={FirstElement} width="60%" alt="The dashboard is shown and the create button is circled"/>
</div>
...
<div style={{textAlign: "center"}}>
<img  src={HierarchyElement} width="80%" alt="The dashboard is shown and the create button is circled"/>
</div>
...
<div style={{textAlign: "center"}}>
<img  src={TypoIntro} width="80%" alt="The dashboard is shown and the create button is circled"/>
</div>
...
<div style={{textAlign: "center"}}>
<img  src={TypoFix} width="80%" alt="The dashboard is shown and the create button is circled"/>
</div>
...
<div style={{textAlign: "center"}}>
<img  src={HierarchyComplete} width="80%" alt="The dashboard is shown and the create button is circled"/>
</div>

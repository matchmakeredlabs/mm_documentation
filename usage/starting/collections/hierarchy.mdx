...
<div style={{textAlign: "center"}}>
<img  src={CreateButton} width="80%" alt="Placeholder alt"/>
</div>
In the dashboard, press the orange “Create” button.
<div style={{textAlign: "center"}}>
<img  src={SearchCollections} width="80%" alt="The manage collections page is visible, and the Enter Keyword box is circled"/>
</div>
...
<div style={{textAlign: "center"}}>
<img  src={SelectedCollection} width="80%" alt="The manage collections page is visible, and the only collection displayed is Math Helps Mathematical Resources, and is circled as well"/>
</div>
...
<div style={{textAlign: "center"}}>
<img  src={IntroHierarchy} width="80%" alt="The collection edit page is shown and sections are boxed and numbered. The name of the collection (1), plus and X buttons (2), a section displaying descriptions (3)"/>
</div>
:::info
...
<div style={{textAlign: "center"}}>
<img  src={MathHelpSite} width="80%" alt="Placeholder alt"/>
</div>

...
3. In [How to Describe Elements](/usage/starting/collections/), we’ll focus on elements which contain no other elements and learn how to describe them for use in matches.

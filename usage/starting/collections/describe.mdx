...
import LastElement from '/static/img/Describe/last_element_descriptor.png'
...
import ReturnElement from '/static/img/Describe/return_last_element.png'
import EnableFeatures from '/static/img/Describe/enable_context_ai.png'
import AiSearch from '/static/img/Describe/complete_ai_search.png'
import UpdatedFirstKey from '/static/img/Describe/1st_updated_key.png'
...
<img src={DescribeIntro} width="60%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={SelectDescribe} width="80%" alt="Placeholder alt"/>
</div>
Press “Browse & Describe” to begin.
<div style={{textAlign: "center"}}>
<img src={SearchCollections} width="80%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={AnnotatedSearch} width="80%" alt="Placeholder alt"/>
</div>
:::info
...
<div style={{textAlign: "center"}}>
<img src={ExpandFirst} width="80%" alt="Placeholder alt"/>
</div>
...
:::tip
<div style={{textAlign: "center"}}>
<img src={LegendGraphic} width="90%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={SelectStart} width="80%" alt="Placeholder alt"/>
</div>
<div style={{textAlign: "center"}}>
<img src={EditDescription} width="80%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={FindSelect} width="80%" alt="Placeholder alt"/>
</div>
:::info
...
<div style={{textAlign: "center"}}>
<img src={StartFirstSearch} width="90%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={SaveFirstPaletKey} width="65%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={DescribeLegend} width="80%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={DescriptorSwitching} width="65%" alt="Placeholder alt"/>
</div>
:::info
...
<div style={{textAlign: "center"}}>
<img src={SecondElement} width="60%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={DeleteStatement} width="50%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={IncompleteSecondKey} width="50%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={DecentralKey} width="60%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={CompleteSecondKey} width="60%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={ThirdKey} width="60%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={IDSearch} width="60%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={LastElement} width="35%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={FirstThirdKey} width="50%" alt="Placeholder alt"/>
<img src={SecondThirdKey} width="50%" alt="Placeholder alt"/>
<img src={ThirdThirdKey} width="50%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={ReturnElement} width="50%" alt="Placeholder alt"/>
</div>
Press the left arrow (←) three times to return to "Completing the Square" (or until you receive an error).
<div style={{textAlign: "center"}}>
<img src={EnableFeatures} width="80%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={AiSearch} width="80%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={UpdatedFirstKey} width="80%" alt="Placeholder alt"/>
</div>
Now, scroll up and press "Save".
## Conclusion

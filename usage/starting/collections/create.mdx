...
<img  src={CreateButton} width="80%" alt="The dashboard is shown and the create button is circled"/>
</div>
...
<div style={{textAlign: "center"}}>
<img  src={CreateCollection} width="55%" alt="A collection create display appears"/>
</div>
:::info
...
<div style={{textAlign: "center"}}>
<img  src={MathHelpCollection} width="60%" alt="A collection preview is displayed"/>
</div>

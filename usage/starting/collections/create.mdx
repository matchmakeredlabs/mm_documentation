...
import CreateCollection from '/static/img/Create/mm_create_collection.png'
import MathHelpCollection from '/static/img/Create/mathhelp_example_collection.png'
...
<div style={{textAlign: "center"}}>
 <img  src={ManageCollectionsIntro} width="80%" alt="The main manage collections page is shown"/>   
 </div>
:::info
...
<div style={{textAlign: "center"}}>
<img  src={CreateCollection} width="45%" alt="A collection create display appears"/>
</div>
:::info
...
<div style={{textAlign: "center"}}>
<img  src={MathHelpCollection} width="45%" alt="A collection preview is displayed"/>
</div>

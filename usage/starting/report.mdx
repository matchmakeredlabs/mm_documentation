...
import SearchStart from '/static/img/Report/collection_search_start.png'
import AddDependent from '/static/img/Report/select_dependent_collection.png'
import DependentAdded from '/static/img/Report/match_mathhelp_added.png'
import RemoveFilter from '/static/img/Report/remove_mathhelp_search.png'
import AddIndependent from '/static/img/Report/select_independent.png'
...
<img src={ReportGraphic} width="50%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={SearchStart} width="80%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={AddDependent} width="80%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={DependentAdded} width="80%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={RemoveFilter} width="80%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={AddIndependent} width="80%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={AllAdded} width="80%" alt="Placeholder alt"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={ReportMatches} width="80%" alt="Placeholder alt"/>
</div>

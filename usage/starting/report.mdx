import ReportGraphic from '/static/img/Report/matching.png'
import ReportButton from '/static/img/Report/generate_report.png'
import MatchButton from '/static/img/Report/click_matchsets.png'
import AnnotatedMatchPage from '/static/img/Report/match_sets_page.png'
import DependentAdded from '/static/img/Report/match_mathhelp_added.png'
import AllAdded from '/static/img/Report/match_sets_ex_both_collections_added.png'
import ReportCollapsed from '/static/img/Report/mathhelp_report_collapsed.png'
import CollectionCollapsed from '/static/img/Report/mathhelp_report_collection_collapsed.png'
import ReportExpanded from '/static/img/Report/mathhelp_report_expanded.png'
import ReportMatches from '/static/img/Report/mathhelp_report_matches.png'
...
<img src={ReportGraphic} width="50%" alt="Metaphors for the terms are described visually: The Palet as an artists Palette, A Palet Statement as a particular color, and a Palet Key as a variety of colors"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={ReportButton} width="50%" alt="Metaphors for the terms are described visually: The Palet as an artists Palette, A Palet Statement as a particular color, and a Palet Key as a variety of colors"/>
</div>
Click on the “Generate Report” button in the Dashboard.
<div style={{textAlign: "center"}}>
<img src={MatchButton} width="50%" alt="Metaphors for the terms are described visually: The Palet as an artists Palette, A Palet Statement as a particular color, and a Palet Key as a variety of colors"/>
</div>
Then click on “Match Sets” to start matching collections.
### Selecting Dependent and Independent Collections
<div style={{textAlign: "center"}}>
<img src={AnnotatedMatchPage} width="50%" alt="Metaphors for the terms are described visually: The Palet as an artists Palette, A Palet Statement as a particular color, and a Palet Key as a variety of colors"/>
</div>
:::info
...
(Screenshot of expanded section w/ search box circled; left as placeholder for now)
...
(Screenshot of Math Help result w/ add to dependent circled; left as placeholder for now)

Since you want to use Math Help’s resources as a pool of knowledge for Malia, add it as a dependent collection by clicking the checkbox underneath “Add to Dependent”.
<div style={{textAlign: "center"}}>
<img src={DependentAdded} width="50%" alt="Metaphors for the terms are described visually: The Palet as an artists Palette, A Palet Statement as a particular color, and a Palet Key as a variety of colors"/>
</div>
Your collection has now been added! Let’s just add in Malia’s algebra 1 curriculum, which is an available and existing collection. 

(Screenshot of query with search field circled; left as placeholder for now)
...
(Screenshot of queries with add to independent circled for Malia; left as placeholder for now)

Click on the checkbox next to “Malia Algebra 1” that sits underneath “Add to Independent” to add “Malia Algebra 1” as an independent collection–or as a search through the pool of Math Help knowledge.
<div style={{textAlign: "center"}}>
<img src={AllAdded} width="50%" alt="Metaphors for the terms are described visually: The Palet as an artists Palette, A Palet Statement as a particular color, and a Palet Key as a variety of colors"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={ReportCollapsed} width="50%" alt="Metaphors for the terms are described visually: The Palet as an artists Palette, A Palet Statement as a particular color, and a Palet Key as a variety of colors"/>
</div>
Click on “> Collections” to expand to see all the independent collections we’ve added (in this case just one).
<div style={{textAlign: "center"}}>
<img src={CollectionCollapsed} width="50%" alt="Metaphors for the terms are described visually: The Palet as an artists Palette, A Palet Statement as a particular color, and a Palet Key as a variety of colors"/>
</div>
Now click on “Malia Algebra 1” to expand the collection and see its hierarchy.
<div style={{textAlign: "center"}}>
<img src={ReportExpanded} width="50%" alt="Metaphors for the terms are described visually: The Palet as an artists Palette, A Palet Statement as a particular color, and a Palet Key as a variety of colors"/>
</div>
...
<div style={{textAlign: "center"}}>
<img src={ReportMatches} width="50%" alt="Metaphors for the terms are described visually: The Palet as an artists Palette, A Palet Statement as a particular color, and a Palet Key as a variety of colors"/>
</div>
Finally an effective set of matches for Malia! Each matching element receives what is called a MatchIndex, a measure of how well it matches, and your matches are organized from greatest to least by their MatchIndex. “Completing the Square” sits at the top as the best match; this is intuitive, as that element is a direct explanation of a method of Solving Quadratic Equations. Furthermore, the other two elements in Math Help sit a little lower as they don’t directly match the topic as well. Now, we can stand assured that Malia will get effective insight on what Math Help resources to access. You then easily integrate MatchMaker into the Math Help site, and let Malia know. Malia then comes into your office crying tears of joy from the deep understanding in Algebra 1 they’ve just received, and Mrs. Math Help is proud of her company’s work yet again.
## Conclusion
